...
<div>
    ...
    <p class="mt-1 text-sm text-muted-foreground">{{ __('Markdown works here') }}</p>
...
<div>
    ...
    <p class="mt-1 text-sm text-muted-foreground">{{ __('Markdown works here. Numbered steps render as an ordered list.') }}</p>
